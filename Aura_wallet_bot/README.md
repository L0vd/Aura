...
3. Aggregates EAURA token info and provides brief highlights regarding the token.
...
/start - start working with bot (select Aura from network list)  
/menu - call menu buttons  
/help - list of commands  

**List of available buttons in the menu:**  
💎 Token Info - Highlights of $EAURA token  
